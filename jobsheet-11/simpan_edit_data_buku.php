<?php
    ...
    $sql = "UPDATE data_buku SET judul_buku = :judul_buku, kode_pengarang = :kode_pengarang, kode_jenis_buku = :kode_jenis_buku, kode_penerbit = :kode_penerbit, isbn = :isbn, tahun = :tahun, deskripsi = :deskripsi, jumlah = :jumlah WHERE kode_buku = :kode_buku";
